...
# Encoder Layer by https://github.com/espnet/espnet/tree/master
...
# Speech-MHA by https://github.com/HappyColor/SpeechFormer2
...
class transformer_encoder(nn.Module):
    """
    Transformer Encoder model for speech emotion recognition.
    
    Architecture:
    - Input: (Batch, Time, Features)
    - Subsampling: Conv2dSubsampling reduces time dimension by 4x.
    - Positional Encoding: Adds positional information to embeddings.
    - Encoder Blocks: Stack of Transformer Encoder layers (Self-Attention + FeedForward).
    - Pooling: Max pooling over time dimension.
    - Classifier: Linear -> LayerNorm -> Tanh -> MaxPool -> Linear.
    
    Args:
        features (int): Input feature dimension.
        classes (int): Number of output classes.
        d_model (int): Dimension of the model embeddings.
        n_heads (int): Number of attention heads.
        num_blocks (int): Number of encoder layers.
    """
    def __init__(self, features, classes, kernel_size=2, d_model=252, dropout_rate=0.3, num_blocks=12, n_heads=12, linear_units=2048, normalize_before=True, concat_after=False, stochastic_depth_rate=0.3, add_pos_enc=True):
        ...
        self.gn = nn.GroupNorm(num_groups=1, num_channels=d_model)
        self.dropout= nn.Dropout(dropout_rate)
