...
class transformer_encoder(nn.Module):
    """
    A Transformer Encoder based model for audio classification. 
    
    Architecture:
    - Input: (batch_size, time_steps, features)
    - Conv2d Subsampling (downsamples time dimension)
    - Positional Encoding
    - Stack of Transformer Encoder Layers (Multi-Head Attention + Feed Forward)
    - Layer Normalization
